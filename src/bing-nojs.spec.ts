...
describe('Parsing Domain-nojs page', () => {
  ...
  test('Testing first ad', () => {
    ...
    expect(adwordsTop).toHaveProperty(['0', 'title'], 'Domain - Free Domain Name - Get a Free Domain Easy & Quick');
    ...
    expect(adwordsTop).toHaveProperty(['0', 'domain'], 'www.bing.com');
    expect(adwordsTop).toHaveProperty(
      ['0', 'snippet'],
  ...
  test(`first top ad card sitelink`, () => {
    ...
    expect(adwordsTop).toHaveProperty(['1', 'sitelinks', '1', 'title'], 'US$8.99 .COM Domains');
    expect(adwordsTop).toHaveProperty(
      ['1', 'sitelinks', '1', 'href'],
